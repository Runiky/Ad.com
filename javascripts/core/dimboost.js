function getDimensionBoostPower() {
  ...
  var ret = 2
  if (player.infinityUpgrades.includes("resetMult")) ret = 28.5
  if (player.challenges.includes("postc7")) ret = 30
  if (player.currentChallenge == "postc7" || player.timestudy.studies.includes(81)) ret = 80
